...
public final class McBorder extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        new Sender(this).sendToLogger("&b     McBorder  v3.0.1-Dependency  Successfully loaded");
    ...
    public void onDisable() {
        new Sender(this).sendToLogger("");
        new Sender(this).sendToLogger("&b     McBorder  v3.0.1-Dependency  Successfully unloaded");
        new Sender(this).sendToLogger("&d                    Made by Yeqi");
        new Sender(this).sendToLogger("");
    }
}
